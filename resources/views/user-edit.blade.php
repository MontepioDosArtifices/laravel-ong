...
<div class="page-wrapper">
  ...
  <div class="container-fluid">
    <form action="{{route('user.edit', ['user' => $user->id])}}" method="post">
      ...
      <input type="text" value="{{$user->cpf}}" name="cpf" class="form-control" placeholder="CPF" maxlength="11">
      ...
      <input type="text" value="{{$user->phone}}" name="phone" class="form-control" placeholder="Telefone">
